    ...
    return (
        <aside>
            <section>
                ...
                <div className="menu">
                    <img src={AsideImg1} className="asideImg" alt="img1" onClick={()=>{changePage("img1")}}/>
                    <hr className="asideHr" />
                    <img src={AsideImg2} className="asideImg" alt="img2" onClick={()=>{changePage("img2")}}/>
                    <hr className="asideHr" />
                    <img src={AsideImg3} className="asideImg" alt="img3" onClick={()=>{changePage("img3")}}/>
                </div>

                <div className="upper">
                    <img src={AsideUpper} className="asideUpper" alt="upper" onClick={()=>{changePage("upper")}} />
                </div>
            </section>
        </aside>
    );
