    ...
    <div id="out">
      <div className="card-grid">
        {cards.map((card) => (
          <div
            key={card.id}
            className={`card test ${card.isFlipped ? "cardRotate" : ""} ${
              card.id === selectedCard ? "clicked" : ""
            }`}
      ...
      {selectedCard !== null ? (
        <div
          className={`card-large ${
            cards[selectedCard - 1].isFlipped ? "cardRotate" : ""
        ...
        >
          <div
            className={`front ${
              cards[selectedCard - 1].isFlipped ? "white" : "hidden"
            }`}
          >
          ...
          <div
            className={`back ${
              cards[selectedCard - 1].isFlipped ? "black" : ""
            }`}
          >
